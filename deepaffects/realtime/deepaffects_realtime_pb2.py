...
_SEGMENTDIARIZEEMOTION = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='text', full_name='deepaffectsrealtime.SegmentDiarizeEmotion.text', index=7,
